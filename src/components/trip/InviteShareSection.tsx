...
interface LiffShareResult {
  status?: string;
}

interface LiffInstance {
  shareTargetPicker?: (messages: Array<{ type: "text"; text: string }>) => Promise<LiffShareResult | null>;
}
...
const InviteShareSection = () => {
  ...
  const handleLineShare = () => {
    ...
    // Check for LIFF
    const liff = (window as Window & { liff?: LiffInstance }).liff;
    if (typeof window !== "undefined" && liff?.shareTargetPicker) {
      liff
